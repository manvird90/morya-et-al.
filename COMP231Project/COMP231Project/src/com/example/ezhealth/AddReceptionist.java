...
public class AddReceptionist extends Activity {
	...
	private Date dob;
	private EditText etFirstName, etLastName, etEmail, etPhone, etDateOfBirth, etApartment, etStreet, etCity, etProvince, etCountry, etPostalCode, etSchedule, etOther;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etSchedule = (EditText) findViewById(R.id.txtSchedule);
		etOther = (EditText) findViewById(R.id.txtOther);
		...
		btnAddReceptionist.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				rt.setReceptionistId(receptionistLoginId);
				...
				rt.setSchedule(etSchedule.getText().toString());
				rt.setOther(etOther.getText().toString());
				
				Log.d("Insert: " , "Receptionist" +etFirstName.getText().toString()+" "+ etLastName.getText().toString());
				db.addReceptionist(rt);
				...
				Toast.makeText(getBaseContext(),"registration successful", Toast.LENGTH_SHORT).show();
					...
					Toast.makeText(getBaseContext(),"Not able to register ", Toast.LENGTH_SHORT).show();
				}
	...
	public boolean validateField(){
		...
		if(etFirstName.getText().toString().equals("")){
			...
			etLastName.setError("Last Name is required!");
		} else if (etSchedule.getText().toString().equals("")){
			etSchedule.setError("field cant be left blank!");
		} else if (etOther.getText().toString().equals("")){
			etOther.setError("field");
		}
		/*
