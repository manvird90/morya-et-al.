...
public class Lab implements Serializable {
    ...
    public Lab(int uid, String firstName, String lastName, String gender, String dob, String email, String phone, String apt, String street,
    ...
    public Lab(int lid, int uid, String firstName, String lastName, String gender, String dob, String email, String phone, String apt, String street,
    		String city, String province, String country, String postalCode){
    	this._labId=lid;
        this._userLoginId=uid;
        this._firstName=firstName;
    ...
    // getting ID
    public int getLabLoginId(){
        return this._userLoginId;
    }
    public void setLabLoginId(int id){
